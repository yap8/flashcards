...
export const COLLECTIONS_SET_ERROR = 'COLLECTIONS_SET_ERROR'
export const COLLECTIONS_SET_LOADING = 'COLLECTIONS_SET_LOADING'
export const COLLECTIONS_SET_SUCCESS = 'COLLECTIONS_SET_SUCCESS'
export const COLLECTIONS_SET_MESSAGE = 'COLLECTIONS_SET_MESSAGE'
